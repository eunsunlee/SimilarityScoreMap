...
def get_args():
    ...
    parser.add_argument('--add_ind', type=int, default=0)
    parser.add_argument('--depth_est', type=int, default=0)

    parser.add_argument('--frontier_type', type=str, default="closest")
    parser.add_argument('--frontier_filter', type=int, default=1) 

    parser.add_argument('--traj_per_scene', type=int, default=1)
    parser.add_argument('--pe_optimizer', type=str, default='adam,lr=0.0001')
    parser.add_argument('--train_pe', type=int, default=0)
    parser.add_argument('--load_pe', type=str, default="0")
    ...
    parser.add_argument('--train_depth', type=int, default=0)
    ...
    parser.add_argument('--load_depth', type=str, default="0")
    ...
    parser.add_argument('-efw', '--env_frame_width', type=int, default=512,
                        help='Frame width (default:84)')
    parser.add_argument('-efh', '--env_frame_height', type=int, default=512,
    ...
    parser.add_argument('--dslam_optimizer', type=str, default='adam,lr=0.0001')
    ...
    if args.num_processes == 18: 
        args.num_processes_on_first_gpu = 3
        args.num_processes_per_gpu = 4
        args.num_processes = 18
        args.sim_gpu_id = 1 
