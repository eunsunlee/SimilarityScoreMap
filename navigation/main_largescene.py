...
from utils.frontiers import get_frontiers_multi, get_frontier_based_global_goals_multi
import random
    ...
    for ep_num in range(num_episodes):
        ...
        for step in range(args.max_episode_length):
            ...
            if l_step == args.num_local_steps - 1 or np.min(dist_to_frontier) < 30:
                ...
                frontiers, stats, obstacle_map, obstacle_region, explored_map, frontier, freq_vals_list  = get_frontiers_multi(args, full_map.detach().clone(), freq_map_by_node_list, 0)
                ...
                global_goals = get_frontier_based_global_goals_multi(args, temp_global_goals, frontiers, stats, full_pose, 0, freq_vals_list, least_sim_node_poses)
